...
<div class="container-card">
        <h1>Leading University Debating Club
    ...
    <div class="gallery-images">
        <div class="gallery">
          <div class="image-section">
            <img src="./ludc/ludc-1.jpg" alt="">
          </div>
          <div class="caption">
            <h3>Leading University Debating Club</h3>
            <p> </p>
          </div>
        </div>
        <div class="gallery">
            <div class="image-section">
              <img src="./ludc/ludc-2.jpg" alt="">
            </div>
            <div class="caption">
              <h3>Leading University Debating Club</h3>
              <p></p>
