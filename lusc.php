...
<div class="container-card">
        <h1>Leading University Sports Club
       ...
       <div class="main-card">
         <div class="cards">
           <div class="card">
             <div class="content">
               <div class="img">
                 <img src="./lusc/lusc-1.webp" alt="">
               </div>
               <div class="details">
                 <div class="name">Md. Mahbubur Rahaman
                 </div>
                 <div class="job">Assistant Professor Head <br>
                 Tourism and Hospitality Management<br>
                 Advisor <br>
                 Leading University Sports Club</div>
               </div>
    ...
    <div class="gallery-images">
        <div class="gallery">
          <div class="image-section">
            <img src="./lusc/lusc-2.jpg" alt="">
          </div>
          <div class="caption">
            <h3>Leading University Sports Club</h3>
            <p>"A massive shoutout to *Shakerzz* for stepping up as our official team jersey sponsor! Your belief in our journey fuels our passion on and off the field. We wear your name with pride, and we couldn't be more thankful for your unwavering support.
