...
<head>
    ...
    <link rel="stylesheet" href="./lutc-style.css" />
</head>
...
<div class="container-card">
        <h1>Leading University Tourist Club (LUTC)
       ...
       <div class="main-card">
         <div class="cards">
           <div class="card">
             <div class="content">
               <div class="img">
                 <img src="./lutc/lutc-1.webp" alt="">
               </div>
               <div class="details">
                 <div class="name">Md. Abdul Halim
    ...
    <div class="gallery-images">
        <div class="gallery">
          <div class="image-section">
            <img src="./lutc/lutc-2jpg.jpg" alt="">
          </div>
          <div class="caption">
            <h3>Leading University Tourist Club-LUTC</h3>
            <p></p>
          </div>
        </div>
        <div class="gallery">
            <div class="image-section">
              <img src="./lutc/lutc-3jpg.jpg" alt="">
            </div>
            <div class="caption">
              <h3>Leading University Tourist Club-LUTC</h3>
              <p></p>
          ...
          <div class="gallery">
            <div class="image-section">
              <img src="./lutc/lutc-4jpg.jpg" alt="">
            </div>
            <div class="caption">
              <h3>Leading University Tourist Club-LUTC</h3>
              <p></p>
          ...
          <div class="gallery">
            <div class="image-section">
              <img src="./lutc/lutc-5jpg.jpg" alt="">
            </div>
            <div class="caption">
              <h3>Leading University Tourist Club-LUTC</h3>
              <p>
          ...
          <div class="gallery">
            <div class="image-section">
              <img src="./lutc/lutc-6jpg.jpg" alt="">
            </div>
            <div class="caption">
              <h3>Leading University Tourist Club-LUTC</h3>
              <p></p>
          ...
          <div class="gallery">
            <div class="image-section">
              <img src="./lutc/lutc-7jpg.jpg" alt="">
            </div>
            <div class="caption">
              <h3>Leading University Tourist Club-LUTC</h3>
              <p></p>
