...
<head>
    ...
    <link rel="stylesheet" href="./bncc-style.css" />
</head>
...
<div class="container-card">
        <h1>BNCC-Leading University Platoon 
    ...
    <div class="gallery-images">
        <div class="gallery">
          <div class="image-section">
            <img src="./bncc/bncc-1.jpg" alt="">
          </div>
          <div class="caption">
            <h3>BNCC-Leading University Platoon</h3>
            <p> </p>
          </div>
        </div>
        <div class="gallery">
            <div class="image-section">
              <img src="./bncc/bncc-2.jpg" alt="">
            </div>
            <div class="caption">
              <h3>BNCC-Leading University Platoon</h3>
              <p></p>
